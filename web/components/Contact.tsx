  ...
  return (
    <section id="contact" className="py-32 px-6 border-t border-[var(--border)]">
      <div className="max-w-6xl mx-auto">
        <p className="font-mono text-xs tracking-widest uppercase opacity-100 mb-16">Contact</p>
        <div className="grid md:grid-cols-2 gap-16">
          <div>
            ...
            <div className="flex flex-col gap-4">
              <a
                ...
                className="font-mono text-sm opacity-100 hover:opacity-100 transition-opacity"
              >
                new@ideawithflo.com
              </a>
              <a
          ...
          >
            <div>
              <label className="font-mono text-xs tracking-widest uppercase opacity-100 block mb-2">Name</label>
              <input
                type="text"
                name="name"
                required
                className="w-full bg-transparent border-b border-[var(--border)] pb-3 focus:outline-none focus:border-[var(--fg)] transition-colors placeholder:opacity-100 font-light"
            ...
            <div>
              <label className="font-mono text-xs tracking-widest uppercase opacity-100 block mb-2">Message</label>
              <textarea
                name="message"
                rows={4}
                required
                className="w-full bg-transparent border-b border-[var(--border)] pb-3 focus:outline-none focus:border-[var(--fg)] transition-colors placeholder:opacity-100 font-light resize-none"
