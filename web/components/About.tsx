  ...
  return (
    <section id="about" className="py-32 px-6">
      <div className="max-w-6xl mx-auto">
        <p className="font-mono text-xs tracking-widest uppercase opacity-40 mb-16">About</p>
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div>
            <p className="font-mono text-xs tracking-widest uppercase opacity-40 mb-6">Skills</p>
            <div className="flex flex-wrap gap-2">
              {skills.map(skill => (
                <span
                  key={skill}
                  className="font-mono text-xs px-3 py-1.5 border border-[var(--border)] opacity-70"
                >
                  {skill}
                </span>
              ))}
