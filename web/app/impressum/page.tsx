    ...
    <div className="min-h-screen bg-[var(--bg)] text-[var(--fg)]">
      ...
      <div className="pt-32 pb-24 px-6 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col gap-10 font-light opacity-100 leading-relaxed">
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-100 mb-3">Unternehmensangaben</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-100 mb-3">Kontakt</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-100 mb-3">Unternehmensgegenstand</h2>
            <p>Industrial Design, Produktentwicklung, Konzeption und Designberatung.</p>
          </div>

          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-100 mb-3">Gerichtsstand</h2>
            <p>Gerichtsstand: Wien, Österreich</p>
          </div>

          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-100 mb-3">Anwendbares Recht</h2>
            <p>Es gilt österreichisches Recht. Anwendbares Recht ist das Recht der Republik Österreich.</p>
          </div>

          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-100 mb-3">Haftungsausschluss</h2>
            <p>Trotz sorgfältiger inhaltlicher Kontrolle übernehmen wir keine Haftung für die Inhalte externer Links. Für den Inhalt der verlinkten Seiten sind ausschließlich deren Betreiber verantwortlich.</p>
          </div>

          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-100 mb-3">Urheberrecht</h2>
