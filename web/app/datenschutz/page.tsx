    ...
    <div className="min-h-screen bg-[var(--bg)] text-[var(--fg)]">
      ...
      <div className="pt-32 pb-24 px-6 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col gap-10 font-light opacity-70 leading-relaxed">
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">1. Verantwortlicher</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">2. Erhobene Daten</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">3. Kontaktformular</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">4. Cookies</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">5. Hosting</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">6. Inhalte (CMS)</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">7. Ihre Rechte</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">8. Beschwerderecht</h2>
          ...
          <p className="font-mono text-xs opacity-40">Stand: März 2026</p>
        </div>
      </div>
