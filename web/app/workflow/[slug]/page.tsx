    ...
    <div className="min-h-screen bg-[var(--bg)] text-[var(--fg)]">
      <div className="fixed top-0 left-0 right-0 z-50 bg-[var(--bg)] border-b border-[var(--border)]">
        <div className="max-w-4xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/workflow" className="font-mono text-xs tracking-widest uppercase opacity-100 hover:opacity-100 transition-opacity">← Workflow</Link>
        </div>
      </div>
      ...
      <div className="pt-16">
        ...
        <div className="max-w-2xl mx-auto px-6 py-16">
          <p className="font-mono text-xs tracking-widest uppercase opacity-100 mb-4">
          ...
          {post.description && (
            <div className="flex flex-col gap-4">
              {post.description.map((block: any, i: number) => (
                <p key={i} className="font-light opacity-100 leading-relaxed text-lg">
