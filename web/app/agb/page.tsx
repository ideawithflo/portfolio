  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--fg)]">
      ...
      <div className="pt-32 pb-24 px-6 max-w-3xl mx-auto">
        ...
        <p className="font-mono text-xs opacity-30 mb-16">Florian Huber e.U. — Stand: März 2026</p>

        <div className="flex flex-col gap-10 font-light opacity-70 leading-relaxed">

          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">§ 1 Geltungsbereich</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">§ 2 Vertragsabschluss</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">§ 3 Leistungsumfang</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">§ 4 Vergütung & Zahlungsbedingungen</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">§ 5 Urheberrecht & Nutzungsrechte</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">§ 6 Mitwirkungspflichten des Auftraggebers</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">§ 7 Kündigung & Stornierung</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">§ 8 Haftung</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">§ 9 Gewährleistung</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">§ 10 Vertraulichkeit</h2>
          ...
          <div>
            <h2 className="font-mono text-xs tracking-widest uppercase opacity-60 mb-3">§ 11 Anwendbares Recht & Gerichtsstand</h2>
      ...
      <footer className="border-t border-[var(--border)] px-6 py-8">
        <div className="max-w-4xl mx-auto flex gap-6">
          <Link href="/impressum" className="font-mono text-xs opacity-30 hover:opacity-60 transition-opacity">Impressum</Link>
          <Link href="/datenschutz" className="font-mono text-xs opacity-30 hover:opacity-60 transition-opacity">Datenschutz</Link>
          <Link href="/agb" className="font-mono text-xs opacity-30 hover:opacity-60 transition-opacity">AGB</Link>
        </div>
      </footer>
    </div>
  )
